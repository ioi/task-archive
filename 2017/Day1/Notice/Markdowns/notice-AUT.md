...
* Beim Testen mit dem Beispiel-Grader sollte dein Input dem Format und den Beschränkungen aus der Aufgabenstellung entsprechen, sonst könnte unspezifiziertes Verhalten auftreten.
