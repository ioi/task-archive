...
* Los envíos no deben leer de la entrada estándar, imprimir a la salida estándar o interactuar con cualquier otro archivo. Sin embargo, si puede imprimir a la salida de error estándar.
