# Notice 
Svaki zadatak ima prikvačeni paket koji je dostupan u CMS-u i na vašoj radnoj površini.

Za "Output-only" taskove:

* Prikvačeni paket sadrži ulazne podatke i primjere uz tekst zadatka. Svaki test podatak je posebni podzadatak.
...
* Output only zadatke smijete zapeći najviše 100 puta. U svakom submissionu smijete poslati bilo koji podskup izlaznih datoteka.

Za sve ostale taskove:
* Prikvačeni paket sadrži sempl grejdere, sempl implementacije, primjere test podataka i compile skripte.
* Trebate submitati točno jednu datoteku i smijete napraviti najviše 50 submissiona.
