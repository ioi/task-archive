...
Usted no debe enviar ningún código fuente para esta tarea.
...
* El mapa de la salida debe coincidir con el mapa de la entrada, con la única excepción que un número arbitrario de caracteres '`.`' en la entrada pueden ser cambiados por caracteres '`X`' (casillas bloqueadas por arbustos).
