...
Faltan pocos días para Nowruz (el nuevo año Persa), y el abuelo ha invitado a su familia a su jardín. Hay $k$ niños entre los invitados. Para hacer la reunión más divertida para los niños, el abuelo va a organizar un juego de escondidas.
...
* El mapa de la salida debe coincidir con el mapa de la entrada, con la única excepción que un número arbitrario de caracteres '`.`' en la entrada pueden ser cambiados por caracteres '`X`' (celdas bloqueadas por arbustos).
