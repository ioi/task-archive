...
Un laberinto debe tener la siguiente propiedad. Para cada par de casillas libres  $a$ y $b$   del laberinto debe existir exactamente un *camino simple* entre ellas. Un camino simple entre las casillas $a$ y $b$ es una secuencia de casillas libres en la cual la primera es $a$, y la ultima es $b$, todas las casillas son distintas y cada par de casillas consecutivas son vecinas.

Un niño puede esconderse en una casilla si y solo si esa casilla es libre y tiene *exactamente* un vecino libre. Dos niños no se pueden esconderse en la misma casilla.
