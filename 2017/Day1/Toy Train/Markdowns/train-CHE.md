...
Manche Stationen sind *Aufladestationen*. Immer wenn der Zug an einer Aufladestation ankommt, wird er voll aufgeladen. Ein voll aufgeladener Zug hat genug Energie, um über $n$ aufeinanderfolgende Gleise zu fahren. Das heisst, die Energie geht aus, sobald der Zug in das $(n+1)$-te Gleis nach dem letzten Aufladen einfährt.
