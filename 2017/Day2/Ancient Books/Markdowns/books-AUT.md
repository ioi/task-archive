...
Dazu erstellte er eine Liste $p$ der Länge $n$, bestehend aus unterschiedlichen ganzen Zahlen von $0$ bis $n-1$. Sie beschreiben die nötigen Änderungen, um die Bücher in alphabetische Reihenfolge zu bringen. Das Buch auf Tisch $i$ soll zu Tisch $p[i]$ gebracht werden, für alle $0 \leq i < n$.
...
* $1 \le n \le 1\,000\,000$
* $0 \le s \le n-1$
* Der Array $p$ besteht aus $n$ verschiedenen ganzen Zahlen von $0$ bis $n-1$ inklusive.
