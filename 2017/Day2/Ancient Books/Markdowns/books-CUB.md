...
La ciudad de Teherán es hogar de la Librería Nacional de Irán.
El principal tesoro de esta libreria se encuentra en un largo pasillo con una fila de $n$ mesas, numeradas de $0$ a $n-1$ de izquierda a derecha.
...
* Luego, camina a la mesa $3$ e intercambia el libro que está cargando con el de la mesa. El nuevo libro que esta cargando debe ser puesto en la mesa $1$.
