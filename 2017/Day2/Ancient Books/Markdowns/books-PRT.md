...
A cidade de Teerão é a casa da Biblioteca Nacional do Irão.
...
Note que o livro da mesa $0$ já está colocado no sítio correto, a mesa $0$, e desse modo Aryan não precisa de pegar nele.
...
O avaliador exemplo escreve uma única linha contendo o valor de retorno de `minimum_walk`.
