...
* para cada par de ciudades, es posible llegar a una desde la otra viajando solo a través de las vías de este conjunto.
...
Aquí, $s[0], s[1],\ldots, s[n-2]$ son las etiquetas de los caminos reales.
