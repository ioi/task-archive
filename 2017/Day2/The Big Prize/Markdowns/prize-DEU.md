# Der Große Preis
Der Große Preis ist eine berühmte Gameshow.
...
Wenn es $k$ Preise vom Typ $t-1$ gibt, dann ist die Anzahl der Preise vom Typ $t$ *strikt größer* ($>$) als $k^2$.
...
Das heißt, dass der Grader in diesen Fällen keine festgelegte Abfolge von Preisen hat.
